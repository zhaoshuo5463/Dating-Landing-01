...
!function(a){var i={};function n(e){if(i[e])return i[e].exports;var t=i[e]={exports:{},id:e,loaded:!1};return a[e].call(t.exports,t,t.exports,n),t.loaded=!0,t.exports}n.m=a,n.c=i,n.p="",n(0)}([function(e,t,a){"use strict";var i=r(a(1)),n=r(a(2)),o=r(a(3));function r(e){return e&&e.__esModule?e:{default:e}}var s=new i.default("_/affiliate-click/AM"),u=new n.default,c=new o.default;window.onload=function(){u.isMobile.bind(window),u.changeMobileLink(),c.intiGoTracker()};for(var d=document.getElementsByClassName("button"),l=document.getElementById("registration"),m=function(e){d[e].addEventListener("click",function(){s.postOnClick(d[e].id),l.submit()})},h=0;h<d.length;h++)m(h)},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var a=function(){function i(e,t){for(var a=0;a<t.length;a++){var i=t[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(e,t,a){return t&&i(e.prototype,t),a&&i(e,a),e}}();var i=function(){function t(e){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,t),this.affiliateClickUrl=e,this.dataObj={data:{}},this.vid="amvid="}return a(t,[{key:"setCookies",value:function(e,t){document.cookie.includes(this.vid)||this.setVidCookie(e);var a=Math.round(ga.getAll()[0].get("clientId")),i=new Date,n=Math.round(i.getTime()/1e3),o=this._generateCookieExpireTime();""!=this.getParameterByName("adgroup")&&(document.cookie="adgroup="+this.getParameterByName("adgroup")+";expires="+o+";Path=/;"),""!=this.getParameterByName("utm_source")&&(document.cookie="analytics_source="+this.getParameterByName("utm_source")+";expires="+o+";Path=/;"),""!=this.getParameterByName("utm_medium")&&(document.cookie="analytics_medium="+this.getParameterByName("utm_medium")+";expires="+o+";Path=/;"),""!=this.getParameterByName("utm_term")&&(document.cookie="analytics_term="+this.getParameterByName("utm_term")+";expires="+o+";Path=/;"),""!=this.getParameterByName("utm_content")&&(document.cookie="analytics_content="+this.getParameterByName("utm_content")+";expires="+o+";Path=/;"),""!=this.getParameterByName("utm_campaign")&&(document.cookie="analytics_campaign="+this.getParameterByName("utm_campaign")+";expires="+o+";Path=/;"),""==this.getParameterByName("ac")&&""!=this.getParameterByName("utm_source")&&this._writeCookie("am_utm",a,365),""==this.getParameterByName("ac")&&this._writeCookie("ots",n,60)}},{key:"postOnClick",value:function(e){if(!this.dataObj.data.vid)for(var t=document.cookie.split(";"),a=0;a<t.length;a++){var i=t[a].trim().split(this.vid);1<i.length&&(this.dataObj.data.vid=i[1])}this.dataObj.data.referrer=document.referrer,this.dataObj.data.afc=this._readCookie("ac"),this.dataObj.data.element=e||"",this.dataObj.data.keywords=this._readCookie("keywords"),this.sendData();var n=document.getElementById("registration");if(n){var o=n.action;window.open(o,"_self")}}},{key:"getParameterByName",value:function(e,t){t||(t=window.location.search),e=e.replace(/[\[\]]/g,"\\$_&");var a=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(t);if(!a)return"";if(!a[2])return"";var i=decodeURIComponent(a[2].replace(/\+/g," "));return this.dataObj.data[e]=i,this.fillInput(e,i),i}},{key:"fillInput",value:function(e,t){document.getElementsByName(e).forEach(function(e){return e.value=t})}},{key:"setVidCookie",value:function(e){var t=this._generateCookieExpireTime();$.ajax({context:this,url:e,method:"GET"}).done(function(e){e=JSON.parse(e).data;document.cookie=this.vid+e+";expires="+t,this.dataObj.data.vid=e})}},{key:"sendData",value:function(){$.ajax({url:this.affiliateClickUrl,method:"POST",contentType:"application/json; charset=utf-8",dataType:"json",data:JSON.stringify(this.dataObj),async:!1})}},{key:"_generateCookieExpireTime",value:function(){var e=new Date,t=e.getTime()+31536e6;return e.setTime(t),e.toGMTString()}},{key:"_writeCookie",value:function(e,t,a){var i=Date.now();a=a||365;var n=new Date(i+864e5*a);document.cookie=e+"="+t+"; expires="+n.toGMTString()+"; path=/"}},{key:"_readCookie",value:function(e){for(var t="",a=e+"=",i=document.cookie.split(";"),n=0;n<i.length;n++){for(var o=i[n];" "==o.charAt(0);)o=o.substring(1,o.length);0==o.indexOf(a)&&(t=o.substring(a.length,o.length))}return t}},{key:"_deleteCookie",value:function(e){document.cookie=e+"=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"}},{key:"_hashCode",value:function(e){return e.split("").reduce(function(e,t){return(e=(e<<5)-e+t.charCodeAt(0))&e},0)}}]),t}();t.default=i},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){var t=this;this.changeMobileLink=function(){if(t.isMobile(this)){var e=$("#mobile-registration a").attr("href");""==e&&(e="https://www.ashleymadison.com/m/register?c=2&lang=en_US"),$("form").attr("action",e)}},this.isMobile=function(){var e=navigator.userAgent||navigator.vendor||window.opera;return/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|PlayBook|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(e)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(e.substr(0,4))}}},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var i=function(){function i(e,t){for(var a=0;a<t.length;a++){var i=t[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(e,t,a){return t&&i(e.prototype,t),a&&i(e,a),e}}();var a=function(){function a(){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,a);var e=window.location.host,t=e.split(".")[0];t!=e&&"127.0.0.1:8080"!=e||(t="www-dev"),this.urlTrack="https://api.ashleymadison.com/tracker/v1/events".replace("www",t),this.gtBaseUrl="https://www.ashleymadison.com/".replace("www",t),this.iframeLoaded=!1,this.trackTrafficSource="ots",this.trackSubSource={},this.cookieOptions={path:"/",domain:window.location.hostname},this.countriesCodes={1:"US",2:"CA",3:"GB",4:"IE",5:"AU",6:"NZ",7:"DE",8:"AT",9:"CH",10:"SE",11:"ES",12:"DK",13:"FI",14:"NR",15:"BR",16:"IT",17:"MX",18:"NL",19:"AR",20:"CO",21:"CL",22:"VE",23:"ZA",24:"FR",25:"BE",26:"GR",27:"JP",28:"IN",29:"PT",30:"HK",31:"TW",32:"SG",33:"PE",34:"LU",35:"IL",36:"KR",37:"MO",38:"SK",39:"PL",40:"HU",41:"CZ",42:"TR",43:"CN",44:"PK",45:"PH",46:"TH",47:"RU",48:"UA",49:"LV",50:"KZ",51:"BY",52:"EE",53:"UR"},this.gtCookiesNames=["current_page","amvid_session_started","event_counter","amvid","previous_page","page_counter","ac","keywords","subuserid","utm_source","utm_medium","utm_term","utm_content","utm_campaign","network"],this.traficSourceParams=["ac","keywords","subuserid","utm_source","utm_medium","utm_term","utm_content","utm_campaign","network"],this.gtLandersTopic="landers",this.gtSignature=this.generateSignature(),this.landingType="contentful"}return i(a,[{key:"generateSignature",value:function(){for(var e="",t=0;t<5;t++)e+=window.navigator.userAgent+window.navigator.platform+window.navigator.appName+window.navigator.appCodeName+window.navigator.product;return window.btoa(window.btoa(e).substr(Math.round(e.length/2),55))}},{key:"getCountryCode",value:function(e){var t=e?e.toString():"??";return this.countriesCodes[t]||"??"}},{key:"setSourseCookiesFromParams",value:function(){for(var e=window.location.search.substring(1).split("&"),t={},a=0,i=e.length;a<i;a++)if(""!==e[a]){var n=e[a].split("="),o=decodeURIComponent(n[0].toLowerCase()),r=decodeURIComponent(n[1]||"");-1<this.traficSourceParams.indexOf(o)&&(t[o]=r)}for(var s in t)t.hasOwnProperty(s)&&jQuery.cookie(""+s,t[s],this.cookieOptions)}},{key:"refreshFrameCookies",value:function(){if(window.navigator.cookieEnabled){this.iframeLoaded=!0;for(var e=[],t=0;t<this.gtCookiesNames.length;t++){var a=this.gtCookiesNames[t],i=jQuery.cookie(a);i&&e.push(encodeURIComponent(a)+"="+encodeURIComponent(i))}console.log("*** gotrack-frame ***"),$("body iframe#gotrack-frame").remove(),$("<iframe>",{src:this.gtBaseUrl+"app/public/gotrack.p?"+e.join("&"),id:"gotrack-frame",frameborder:0,width:0,height:0,scrolling:"no"}).appendTo($("body"))}}},{key:"initTracker",value:function(){this.setSourseCookiesFromParams(),this.trackTrafficSource=this.getTrafficSource(),this.trackSubSource=this.getSubSource()}},{key:"initEvents",value:function(){this.initPageCloseEvent(),this.initLinksClicks(),this.initCountryChange(),this.initLangChange()}},{key:"initPageCloseEvent",value:function(){var t=this;window.onbeforeunload=function(e){t.sendClosePageEvent()}}},{key:"updateNextLocation",value:function(e){var t=document.createElement("a");t.href=e,location.hostname+location.pathname!=t.hostname+t.pathname&&this.setCurrentPage(e)}},{key:"initLinksClicks",value:function(){$('a[href!="#"]').click(function(e){var t=$(this).attr("href");void 0!==t&&(updateNextLocation(t),sendLinkClickEvent($(this).text(),t))})}},{key:"initCountryChange",value:function(){$("#countrySelect").on("change",function(e){this.sendChangeCountryEvent(this.value)})}},{key:"initLangChange",value:function(){$("#languageSelect").on("change",function(e){this.sendChangeLangEvent(this.value)})}},{key:"setCurrentPage",value:function(e){var t=jQuery.cookie("current_page");t||(t=""),jQuery.cookie("previous_page",t,this.cookieOptions),jQuery.cookie("current_page",encodeURIComponent(e),this.cookieOptions)}},{key:"getOrCreatePageId",value:function(){var e=jQuery.cookie("current_page");if(null!=e&&""!==e)return e;var t=window.location.pathname+window.location.search;return this.setCurrentPage(t),t}},{key:"isNewPage",value:function(){return!0}},{key:"getPageCounter",value:function(){var e=jQuery.cookie("current_page"),t=jQuery.cookie("page_counter");if(!t||!e)return jQuery.cookie("page_counter",1,this.cookieOptions),this.setCurrentPage(window.location.pathname+window.location.search),1;var a=parseInt(t);return decodeURIComponent(e)===window.location.pathname+window.location.search||(a++,jQuery.cookie("page_counter",a,this.cookieOptions),this.setCurrentPage(window.location.pathname+window.location.search),this.resetEventCounter()),a}},{key:"getEventCounter",value:function(){var e=jQuery.cookie("event_counter");return e?parseInt(e):0}},{key:"incEventCounter",value:function(){var e=this.getEventCounter();jQuery.cookie("event_counter",e+1,this.cookieOptions)}},{key:"resetEventCounter",value:function(){jQuery.cookie("event_counter",0,this.cookieOptions)}},{key:"getDefaultEvent",value:function(){var e;if(window.navigator.cookieEnabled){var t=this.getPageCounter(),a=jQuery.cookie("amvid"),i=jQuery.cookie("referer");null==i&&(i=""),(e={data:{payload:{domain:window.location.hostname,page_id:this.getOrCreatePageId(),prev_page_id:jQuery.cookie("previous_page"),lang:jQuery.cookie("lang"),country:this.getCountryCode(jQuery.cookie("country")),referer:encodeURIComponent(i),publisher:this.trackTrafficSource,sub_source:this.trackSubSource,page_counter:t}}}).data.vid=null!=a?a:"",e.data.uuid=""}else e={data:{vid:this.gtSignature,payload:{cookiesEnabled:!1,domain:window.location.hostname,page_id:window.location.pathname+window.location.search}}};return e}},{key:"getTrafficSource",value:function(){var e="ots",t=jQuery.cookie("utm_source"),a=jQuery.cookie("ac");return t?e="utm":a&&(e="affiliate"),e}},{key:"getSubSource",value:function(){var e={};if("ots"==this.trackTrafficSource)return e;switch(this.trackTrafficSource){case"utm":e={source:jQuery.cookie("utm_source"),medium:jQuery.cookie("utm_medium"),term:jQuery.cookie("utm_term"),content:jQuery.cookie("utm_content"),campaign:jQuery.cookie("utm_campaign"),network:jQuery.cookie("network")};break;case"affiliate":e={affiliate_id:jQuery.cookie("ac"),subuser_id:jQuery.cookie("subuserid"),keywords:jQuery.cookie("keywords")}}return e}},{key:"setVid",value:function(e,t){console.log("vid should be set here");var a={path:"/",domain:window.location.hostname};jQuery.cookie("amvid")||(jQuery.cookie("amvid",e.vid,a),void 0!==e.created_at&&null!==e.created_at&&jQuery.cookie("amvid_session_started",Math.round(Date.now()/1e3),a),t.sendVidCreatedEvent())}},{key:"modifyEventCounter",value:function(e){window.navigator.cookieEnabled&&(this.incEventCounter(),e.data.payload.event_counter=this.getEventCounter())}},{key:"sendEvent",value:function(e,t){this.modifyEventCounter(e);var a=!1;if(window.XMLHttpRequest)a=new XMLHttpRequest;else{if(!window.ActiveXObject)return!1;try{a=new ActiveXObject("Msxml2.XMLHTTP")}catch(e){try{a=new ActiveXObject("Microsoft.XMLHTTP")}catch(e){}}}if(void 0!==t){var i=this;a.onreadystatechange=function(){var e=a.responseText;void 0!==e&&""!==e&&0===e.indexOf("{")&&t(JSON.parse(e),i),!1===i.iframeLoaded&&i.refreshFrameCookies()};var n=Math.round(Date.now()/1e3);a.open("POST",this.urlTrack,!0),a.setRequestHeader("Content-Type","application/json; charset=UTF-8"),a.setRequestHeader("T-EVENT-ID",e.data.event_id),a.setRequestHeader("T-SUBEVENT-ID",e.data.sub_event_id),a.setRequestHeader("T-AM-VID",e.data.vid),a.setRequestHeader("T-UID",e.data.uuid),a.setRequestHeader("T-TIMESTAMP",n),a.setRequestHeader("T-SIGNATURE",this.gtSignature),a.setRequestHeader("T-TAG",this.landingType),a.send(JSON.stringify(e.data.payload))}}},{key:"sendOpenPageEvent",value:function(){if(this.isNewPage()){var e=this.getDefaultEvent();e.data.event_id=this.gtLandersTopic,e.data.sub_event_id="page_open",this.sendEvent(e,this.setVid)}}},{key:"sendClosePageEvent",value:function(){var e=this.getDefaultEvent();e.data.event_id=this.gtLandersTopic,e.data.sub_event_id="page_close",this.sendEvent(e,this.setVid)}},{key:"sendVidCreatedEvent",value:function(){var e=this.getDefaultEvent();e.data.event_id=this.gtLandersTopic,e.data.sub_event_id="create_new_vid",this.sendEvent(e,this.setVid)}},{key:"sendLinkClickEvent",value:function(e,t){var a=this.getDefaultEvent();a.data.event_id=this.gtLandersTopic,a.data.sub_event_id="link_click",a.data.payload.next_page=t,a.data.payload.link_text=e,this.sendEvent(a,this.setVid)}},{key:"sendChangeLangEvent",value:function(e){var t=this.getDefaultEvent();t.data.event_id=this.gtLandersTopic,t.data.sub_event_id="lang_change",t.data.payload.new_lang=e,this.sendEvent(t,this.setVid)}},{key:"sendChangeCountryEvent",value:function(e){var t=this.getDefaultEvent();t.data.event_id=this.gtLandersTopic,t.data.sub_event_id="country_change",t.data.payload.new_country=this.getCountryCode(e),this.sendEvent(t,this.setVid)}},{key:"sendFormSubmitEvent",value:function(e){var t=this.getDefaultEvent();t.data.event_id=this.gtLandersTopic,t.data.sub_event_id="form_submit",t.data.payload.form_id=e.id,t.data.payload.form_name=e.name,t.data.payload.form_action=e.action,t.data.payload.form_method=e.method,this.sendEvent(t,this.setVid)}},{key:"intiGoTracker",value:function(){console.log("Begin go track!"),this.initTracker(),this.initEvents(),this.sendOpenPageEvent()}}]),a}();t.default=a}]);
!function(e,n,t,a,c,s,d,i,m){n.className+=" "+t,s.start=1*new Date,s.end=d=function(){n.className=n.className.replace(RegExp(" ?"+t),"")},(e[a]=e[a]||[]).hide=s,setTimeout(function(){d(),s.end=null},650),s.timeout=650}(window,document.documentElement,"async-hide","dataLayer",0,{"GTM-W8DHT8":!0});
 function utmx_section(){}function utmx(){}!function(){var t=document,e=t.location,n=t.cookie;function s(t){if(n){var e=n.indexOf(t+"=");if(-1<e){var s=n.indexOf(";",e);return n.substring(e+t.length+1,s<0?n.length:s)}}}var i=s("__utmx"),u=s("__utmxx"),c=e.hash;t.write('<script src="http'+("https:"==e.protocol?"s://ssl":"://www")+".google-analytics.com/siteopt.js?v=1&utmxkey=1907493142&utmx="+(i||"")+"&utmxx="+(u||"")+"&utmxtime="+(new Date).valueOf()+(c?"&utmxhash="+escape(c.substr(1)):"")+'" type="text/javascript" charset="utf-8" async><\/script>')}();
var params=getUrlVars(),source=getClickThroughValue("amsource",params.source),userid=getClickThroughValue("amuserid",params.userid),subsource=getClickThroughValue("amsubsource",params.subsource),queryString=window.location.search.substr(1),trackUrl="https://www.ashleymadison.com/app/public/track.p?signup=1&"+queryString,clickUrl="https://www.ashleymadison.com/amsite_v2.php?uri=app/public/click&",currentUrl=window.location.host,parts=currentUrl.split("."),sub=parts[0];sub==currentUrl&&(sub="www-dev"),clickUrl=clickUrl.replace("www",sub),trackUrl=trackUrl.replace("www",sub),$("body").append("<iframe src="+trackUrl+' width="0" height="0" frameborder="0"></iframe>'),$("form.update-link").each(function(e){var r=$(this).attr("action").replace("www",sub);$(this).attr("action",r)}),$("a.update-link").each(function(e){var r=$(this).attr("href").replace("www",sub);$(this).attr("href",r)});var sourceElements=document.getElementsByName("source");updateInputs(sourceElements,source);var subsourceElements=document.getElementsByName("subsource");updateInputs(subsourceElements,subsource);var useridElements=document.getElementsByName("userid");function updateInputs(e,r){for(var t=0;t<e.length;t++)e[t].value=r}function getClickThroughValue(e,r){var t=cookie_read(e);return""!==t&&null!==t||(t=r),t}function cookie_read(e){for(var r=e+"=",t=document.cookie.split(";"),s=0;s<t.length;s++){for(var u=t[s];" "==u.charAt(0);)u=u.substring(1,u.length);if(0==u.indexOf(r))return u.substring(r.length,u.length)}return null}function getUrlVars(){for(var e,r=[],t=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),s=0;s<t.length;s++)r[(e=t[s].split("="))[0]]=e[1];return r}updateInputs(useridElements,userid);
$(function(){if($("html").hasClass("original-static")){function n(){var n=$(window).width(),i=window.pageYOffset||document.documentElement.scrollTop;n<=767?$(".sticky-nav").fadeIn(250):767<n&&400<=i?$(".sticky-nav").fadeIn(250):$(".sticky-nav").fadeOut(250)}n(),$(window).resize(function(){n()}),$(window).scroll(function(){n()})}});
$(function(){if($("html").hasClass("fullscreen-video")){function e(){var e=$(window).width(),n=window.pageYOffset||document.documentElement.scrollTop;e<=767?($(".sticky-nav").fadeIn(250),40<=n?$(".sticky-nav").css({"background-color":"#ffffff","box-shadow":"0 3px 7px rgba(0,0,0,0.2)"}):$(".sticky-nav").css({"background-color":"transparent","box-shadow":"none"})):767<e&&400<=n?($(".sticky-nav").fadeIn(250),$(".sticky-nav").css({"background-color":"#ffffff","box-shadow":"0 3px 7px rgba(0,0,0,0.2)"})):$(".sticky-nav").fadeOut(0)}e(),$(window).resize(function(){e()}),$(window).scroll(function(){e()});var n=document.getElementById("video-con"),t=document.createElement("source"),o=document.createElement("source");n.appendChild(t),n.appendChild(o);var i=!1;function a(){n.load(),n.play()}function r(){var e=window.innerWidth,n=function(){for(var e=document.getElementsByTagName("link"),n=!1,t=0;t<e.length;t++)if("canonical"===e[t].getAttribute("rel")){n=-1<e[t].getAttribute("href").indexOf("ashleyrnadison");break}return n}()?"https://lander-cdn.ashleyrnadison.com":"https://lander-cdn.ashleymadison.com";i=e<=440?(t.setAttribute("src",n+"/images/-mobile.mp4"),o.setAttribute("src",n+"/images/-mobile.ogv"),a(),!0):(t.setAttribute("src",n+"/images/-desktop.mp4"),o.setAttribute("src",n+"/images/-desktop.ogv"),a(),!1)}window.addEventListener("resize",function(){var e=window.innerWidth;if(e<=440){if(!0===i)return;r()}else if(440<e){if(!1===i)return;r()}}),r()}});
function acceptGDPR(){$.cookie("cookie-consent",1,{path:"/",expires:365}),$(".gdprBar").hide()}function bindEvents(){$(document).on("click","a",function(){acceptGDPR()})}function showGDPR(){var c=$.cookie("cookie-consent"),n=["AT","BE","BG","CY","CZ","DE","DK","EE","ES","FI","FR","GB","GR","HR","HU","IE","IT","LT","LU","LV","MT","NL","PL","PT","RO","SE","SI","SK"];$.get("https://www.ashleymadison.com/search/geo/ip",function(o){!c&&n.includes(o.country_code)&&($(".gdprBar").show(),$(".gdprFooterLink").show(),bindEvents())}).catch(function(o){})}showGDPR();
